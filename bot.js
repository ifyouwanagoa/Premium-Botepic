...
client.on('message', message => {//Toxic Codes
  ...
  if (message.content.startsWith(prefix + "bi")) {//Toxic Codes
    var embed = new Discord.RichEmbed()
    .setTitle("صورة السيرفر")  //Toxic Codes 
...
client.on('message', message => {
     ...
     let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)
.addField('     **اولا** ' ,' **ممنوع الكلام لاي عضو بالتريقه او السخريه او بالاساءه** ')
.addField('     **ثانيا** ' ,' **ممنوع الشتايم والالفاظ الخارجه  ** ')
.addField('     **ثالثا** ' ,' ** ممنوع البيض والروشنه والحك** ')
.addField('    **رابعا**' ,' **ممنوع الكلام في السياسه والدين
** ')
.addField('    **خامسا**' ,' **ممنوع نشر اعلان  لسيرفرك** ')
.addField('    **سادسا**' ,' **ممنوع تطلب اي رانك علشان هنعملك بان** ')
.addField('    **سابعا**' ,' ** لو طلعت من السيرفر او اتعملك بان علشان خالفت القوانين متطلبش الرانك الي كانت معاك تاني!** ')
